...
Vagrant.configure("2") do |config|
  ...
  # 1. Выбираем операционку (скачается сама)
  #config.vm.box = "ubuntu/jammy64"  
#  config.vm.box = "ubuntu/noble"
  config.vm.box = "generic/debian12"
  #config.vm.box_url = "https://mirror.yandex.ru/ubuntu-cloud-images/vagrant/noble/current/noble-server-cloudimg-amd64-vagrant.json"
